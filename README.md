...
The `jazzy` branch targets ROS 2 Jazzy on Ubuntu 24.04. Install ROS 2 Jazzy following the [offical instructions for Ubuntu](https://docs.ros.org/en/jazzy/Installation/Ubuntu-Install-Debs.html).
...
<details>
  ...
  For more information on using rosdep to manage package dependencies, see the [official documentation](https://docs.ros.org/en/jazzy/Tutorials/Intermediate/Rosdep.html). The following uses the following parameters:
